...
write.csv(edge_turquoise, file = "Infant_edge_turquoise_-1(filtered 0.8hubgenes + 0.45weightcut-off).csv", row.names = FALSE)
...
write.csv(Network_goi, file ="Network_genes of interest_Infant.csv", row.names = FALSE)
...
# saving ***********
save.image(file = "GSE239662_coding+noncoding_Infant.RData")
